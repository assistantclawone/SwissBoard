...
import { useUser, useFirestore, useDoc, useCollection, useMemoFirebase, collection, doc, serverTimestamp, deleteDoc, updateDoc, addDoc } from '@/firebase';
...
export function WallBody({ id }: { id: string }) {
